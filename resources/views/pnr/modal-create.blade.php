...
@csrf
          <div class="modal-body">
              ...
              <label for="text">Tipo de PNR</label>
              <input type="text" name="tipoPNR" id="" class="form-control">
              
              <label for="text">Descripcion</label>
              <input type="text" name="descripcion" id="" class="form-control">
              
              <label for="text">Repartidor</label>
              <input type="text" name="repartidor" id="" class="form-control">
